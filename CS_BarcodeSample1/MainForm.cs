...
namespace CS_BarcodeSample1
{
    ...
    public class MainForm : System.Windows.Forms.Form
    {
        ...
        private void loadScanContinuousDataListView()
        {
            ...
            {
                // Start a read operation & attach a handler.
                myScanSampleAPI.StartRead(true);
                this.myReadNotifyHandler = new EventHandler(myReader_ReadNotify);
                myScanSampleAPI.AttachReadNotify(myReadNotifyHandler);
        ...
        private void loadOptionsListViewItems()
        {
            ...
            switch (myScanSampleAPI.Reader.ReaderParameters.ReaderType)
            {
                case Symbol.Barcode.READER_TYPE.READER_TYPE_IMAGER:
                    aimType = myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.ImagerSpecific.AimType.ToString();
                    aimMode = myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.ImagerSpecific.AimMode.ToString();
                    break;
                case Symbol.Barcode.READER_TYPE.READER_TYPE_LASER:
                    aimType = myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.LaserSpecific.AimType.ToString();
                    aimMode = myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.LaserSpecific.AimMode.ToString();
                    break;
            ...
            scanType = myScanSampleAPI.Reader.Parameters.ScanType.ToString();
            ...
            addListViewItem(i++, CODE128, (myScanSampleAPI.Reader.Decoders.CODE128.Enabled== true) ? ENABLED : DISABLED );
            addListViewItem(i++, CODE39, (myScanSampleAPI.Reader.Decoders.CODE39.Enabled == true) ? ENABLED : DISABLED);
        }
        ...
        private void listViewMain_ItemActivate(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                switch (listViewMain.Items[listViewMain.SelectedIndices[0]].SubItems[nameColumn].Text)
                {
                    ...
                    case AIMTYPE_TRIGGER:
                        ...
                        {
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_IMAGER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.ImagerSpecific.AimType = Symbol.Barcode.AIM_TYPE.AIM_TYPE_TRIGGER;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_LASER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.LaserSpecific.AimType = Symbol.Barcode.AIM_TYPE.AIM_TYPE_TRIGGER;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_CONTACT:
                                // AimType is not supported by the contact readers.
                                break;
                        ...
                        myScanSampleAPI.Reader.Actions.SetParameters();
                    ...
                    case AIMTYPE_HOLD:
                        ...
                        {
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_IMAGER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.ImagerSpecific.AimType = Symbol.Barcode.AIM_TYPE.AIM_TYPE_TIMED_HOLD;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_LASER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.LaserSpecific.AimType = Symbol.Barcode.AIM_TYPE.AIM_TYPE_TIMED_HOLD;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_CONTACT:
                                // AimType is not supported by the contact readers.
                                break;
                    ...
                    case AIMTYPE_RELEASE:
                        ...
                        {
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_IMAGER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.ImagerSpecific.AimType = Symbol.Barcode.AIM_TYPE.AIM_TYPE_TIMED_RELEASE;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_LASER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.LaserSpecific.AimType = Symbol.Barcode.AIM_TYPE.AIM_TYPE_TIMED_RELEASE;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_CONTACT:
                                // AimType is not supported by the contact readers.
                                break;
                    ...
                    case AIMMODE_NONE:
                        ...
                        {
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_IMAGER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.ImagerSpecific.AimMode = Symbol.Barcode.AIM_MODE.AIM_MODE_NONE;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_LASER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.LaserSpecific.AimMode = Symbol.Barcode.AIM_MODE.AIM_MODE_NONE;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_CONTACT:
                                // AimMode is not supported by the contact readers.
                                break;
                        }
                    ...
                    case AIMMODE_DOT:
                        ...
                        {
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_IMAGER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.ImagerSpecific.AimMode = Symbol.Barcode.AIM_MODE.AIM_MODE_DOT;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_LASER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.LaserSpecific.AimMode = Symbol.Barcode.AIM_MODE.AIM_MODE_DOT;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_CONTACT:
                                // AimMode is not supported by the contact readers.
                                break;
                    ...
                    case AIMMODE_SLAB:
                        ...
                        {
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_IMAGER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.ImagerSpecific.AimMode = Symbol.Barcode.AIM_MODE.AIM_MODE_SLAB;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_LASER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.LaserSpecific.AimMode = Symbol.Barcode.AIM_MODE.AIM_MODE_SLAB;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_CONTACT:
                                // AimMode is not supported by the contact readers.
                                break;
                    ...
                    case AIMMODE_RETICLE:
                        ...
                        {
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_IMAGER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.ImagerSpecific.AimMode = Symbol.Barcode.AIM_MODE.AIM_MODE_RETICLE;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_LASER:
                                myScanSampleAPI.Reader.ReaderParameters.ReaderSpecific.LaserSpecific.AimMode = Symbol.Barcode.AIM_MODE.AIM_MODE_RETICLE;
                                break;
                            case Symbol.Barcode.READER_TYPE.READER_TYPE_CONTACT:
                                // AimMode is not supported by the contact readers.
                                break;
                    ...
                    case SCANTYPE_FOREGROUND:
                        ...
                        myScanSampleAPI.Reader.Parameters.ScanType = Symbol.Barcode.ScanTypes.Foreground;
                        myScanSampleAPI.Reader.Actions.SetParameters();
                    ...
                    case SCANTYPE_BACKGROUND:
                        ...
                        myScanSampleAPI.Reader.Parameters.ScanType = Symbol.Barcode.ScanTypes.Background;
                        myScanSampleAPI.Reader.Actions.SetParameters();
                    ...
                    case SCANTYPE_MONITOR:
                        ...
                        myScanSampleAPI.Reader.Parameters.ScanType = Symbol.Barcode.ScanTypes.Monitor;
                        myScanSampleAPI.Reader.Actions.SetParameters();
                    ...
                    case ENABLED:
                        ...
                        {
                            myScanSampleAPI.Reader.Decoders.CODE128.Enabled = true;
                            myScanSampleAPI.Reader.Actions.SetParameters();
                        }
                        else
                        {
                            myScanSampleAPI.Reader.Decoders.CODE39.Enabled = true;
                            myScanSampleAPI.Reader.Actions.SetParameters();
                        }
                    ...
                    case DISABLED:
                        ...
                        if (currentListView == CODE128)
                        {
                            myScanSampleAPI.Reader.Decoders.CODE128.Enabled = false;
                            myScanSampleAPI.Reader.Actions.SetParameters();
                        }
                        else
                        {
                            myScanSampleAPI.Reader.Decoders.CODE39.Enabled = false;
                            myScanSampleAPI.Reader.Actions.SetParameters();
                        }
            ...
            {
                System.Windows.Forms.MessageBox.Show(Resources.GetString("ItemNotSelected"), Resources.GetString("CS_BarcodeSample1"));
                this.listViewMain.Focus();
            }
            Cursor.Current = savedCursor;
        }
            ...
            else
            {
                ...
                switch (TheStatusData.State)
                {
                    case Symbol.Barcode.States.WAITING:
                        ...
                        if ((currentListView == SCAN_CONTINUOUS) && (prevState == Symbol.Barcode.States.READY))
                        {
                            this.myScanSampleAPI.StopRead();
                            this.myScanSampleAPI.StartRead(true);
                        }
        ...
        {
            listViewMain.Items[1].SubItems[2].Text = TheReaderData.Text;
            listViewMain.Items[2].SubItems[2].Text = TheReaderData.TypeHex;
            listViewMain.Items[3].SubItems[2].Text = TheReaderData.Source;
            listViewMain.Items[4].SubItems[2].Text = TheReaderData.TimeStamp.ToString();
            listViewMain.Items[5].SubItems[2].Text = TheReaderData.Length.ToString();
            
        }

        /// <summary>
        /// Handle data from the reader. Used in the scan continuous mode.
        /// </summary>
        private void HandleContinuousData(Symbol.Barcode.ReaderData TheReaderData)
        {
            appendListViewContinuousDataItem(TheReaderData.Text);
        }

        private void MainForm_Activated(object sender, EventArgs e)
        {
            this.myScanSampleAPI.isBackground = false;
        ...
        private void MainForm_Deactivate(object sender, EventArgs e)
        {
            ...
            this.myScanSampleAPI.isBackground = true;
        }
