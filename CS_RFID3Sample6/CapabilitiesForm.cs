...
namespace CS_RFID3Sample6
{
    public partial class CapabilitiesForm : Form
    {
        ...
        private void CapabilitiesForm_Load(object sender, EventArgs e)
        {
            try
            {
                if (m_AppForm.m_IsConnected)
                {
                    ...
                    capView.Items.Add(item);
                    item = new ListViewItem("Max No. of Operations In AccessSequence");
                    ...
                    capView.Items.Add(item);
                    item = new ListViewItem("Communication Standard");
                ...
                {
                    this.m_AppForm.notifyUser("Please connect to a reader", "Capabilities");
                }
            }
            catch (Exception ex)
            {
                this.m_AppForm.notifyUser(ex.Message, "Capabilities");
            }
        }
