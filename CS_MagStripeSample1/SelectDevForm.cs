...
namespace CS_MagStripeSample1
{
	...
	public class SelectDevForm : System.Windows.Forms.Form
	{
		...
		public SelectDevForm()
		{
			...
			foreach (Symbol.MagStripe.Device device in Symbol.MagStripe.Device.AvailableDevices)
			{
		...
		{
			cbDevices.SelectedItem = Symbol.MagStripe.Device.AvailableDevices[0].FriendlyName;
		}
		...
		{
			devName = Symbol.MagStripe.Device.AvailableDevices[cbDevices.SelectedIndex].DeviceName;
			this.Close();
		}
