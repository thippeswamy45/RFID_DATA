...
namespace CS_Imager2Sample1
{
	...
	/// list of available Symbol.Imaging2.Device objects.
	/// </summary>
	/// <remarks>
	...
	public class SelectDevice : System.Windows.Forms.Form
	{
		...
		static private Symbol.Imaging2.Device[] OurAvailableDevices = null;
		...
		public static Symbol.Imaging2.Device Select(
            string Title, Symbol.Imaging2.Device[] AvailableDevices)
		{
		...
		/// object.</param>
		/// <returns>The selected device object.</returns>
        public static Symbol.Imaging2.Device Select(string Title,
            Symbol.Imaging2.Device[] AvailableDevices, int SelectIndex)
		{
			OurAvailableDevices = AvailableDevices;
		...
		private void SelectDevice_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                foreach (Symbol.Imaging2.Device d in OurAvailableDevices)
                {
